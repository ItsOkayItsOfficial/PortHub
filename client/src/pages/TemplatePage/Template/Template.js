  ...
  return (
    <div style={{margin:'5px'}}>
      ...
      <div className='dashboardFooter'>
        ...
        {dashboardTemplate.url ? <Aux><a  className='htmlButton' href={`https://${dashboardTemplate.url}`} target='_blank' data-tip="React-tooltip" data-for='githubTooltip'><i className="fa fa-github fa-2x" aria-hidden="true"></i></a>
        <ReactTooltip id='githubTooltip' effect="solid">Go to {dashboardTemplate.url} </ReactTooltip></Aux> : ''}
