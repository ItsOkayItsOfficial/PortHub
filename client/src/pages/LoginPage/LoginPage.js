        ...
        <div className="col-lg-6 border border-dark border-left-0 border-bottom-0 border-top-0" style={{boxShadow:'none'}}>
            <form>
              <div className="form-group">
                ...
                <input type="email" disabled title="disabled for this version" className="form-control" id="exampleInputEmail" aria-describedby="emailHelp" placeholder="Enter email" />
                <small id="emailHelp" className="form-text text-muted">We'll never share your email with anyone else.</small>
              </div>
              <div className="form-group">
                <label htmlFor="exampleInputPassword">Password</label>
                <input type="password" disabled title="disabled for this version" className="form-control" id="exampleInputPassword" placeholder="Password" />
              </div>
